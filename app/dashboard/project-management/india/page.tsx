        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-2xl">{IndiaLocalizationService.formatCurrency(currentProject.budget)}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-3">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-2xl">{milestones.length}</CardTitle>
            </CardHeader>
          </Card>
        </div>
